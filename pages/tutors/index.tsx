      ...
      <section className="courses-page-section style-two overflow-auto">
          ...
          <div className="filter-box">
            <div className="box-inner">
              <div className="clearfix">
                ...
                <form style={{ maxWidth: '600px', width: '100%' }} className="d-inline-block mt-1" onSubmit={handleSearchTutors}>
                  <Row>
                    <Col>
                      <InputGroup>
                        <Input
        ...
        <div className="outer-container">
          <div className="row clearfix">
            ...
            { !tutors?.length ? <h3 className="text-classRoom text-error my-5">No tutor found!</h3> : '' }
          </div>
        </div>
        <Pagination
